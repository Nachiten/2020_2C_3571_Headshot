...
namespace TGC.MonoGame.Samples.Viewer.GUI
{
    ...
    public class AxisLines
    {
        ...
        private void CreateVertexBuffer()
        {
            ...
            AxisLinesVertices[1] = new VertexPositionColor(Vector3.UnitX * 250, Color.Red);
            // Green = +y Axis
            AxisLinesVertices[2] = new VertexPositionColor(Vector3.Zero, Color.Green);
            AxisLinesVertices[3] = new VertexPositionColor(Vector3.UnitY * 250, Color.Green);
            // Blue = +z Axis
            AxisLinesVertices[4] = new VertexPositionColor(Vector3.UnitZ * 250, Color.Blue);
