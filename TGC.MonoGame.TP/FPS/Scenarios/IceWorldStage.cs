...
namespace TGC.MonoGame.TP.FPS.Scenarios
{
    public class IceWorldStage : AStage
    {
        ...
        public override void LoadContent()
        {
            ...
            enemyPath.Add(new PathTrace { posicion = new Vector2(0, 300), normal = -Vector3.UnitZ }); //1
            enemyPath.Add(new PathTrace { posicion = new Vector2(0, 0), normal = Vector3.UnitX }); //2

            // Inicializacion enemigo
            //ToDo: modificar porque esta alto y se hunde para adentro.

            //Enemigos.Add(new Enemigo(Enemy1Pos, new M4(Enemy1Pos), MathHelper.Pi, enemyPath));
            //Enemigos.Add(new Enemigo(Enemy2Pos, new M4(Enemy2Pos), 0, enemyPath));
